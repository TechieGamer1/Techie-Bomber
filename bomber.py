...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/TechieGamer1/Techie-Bomber/archive/dev.zip"
        dir_name = "Techie-Bomber-dev"
    else:
        zip_url = "https://github.com/TechieGamer1/Techie-Bomber/archive/master.zip"
        dir_name = "Techie-Bomber-master"
    ...
    if success:
        mesgdcrt.SuccessMessage("Techie-Bomber was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update Techie-Bomber.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/TechieGamer1/Techie-Bomber.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/TechieGamer1/Techie-Bomber.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/TechieGamer1/Techie-Bomber/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("Techie-Bomber is up-to-date")
        mesgdcrt.GeneralMessage("Starting Techie-Bomber")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/TechieGamer1/Techie-Bomber/raw/dev/.notify"
        else:
            url = "https://github.com/TechieGamer1/Techie-Bomber/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Techie-Bomber was created by Techie Gamer")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("Techie-Bomber will work only in Python v3")
    sys.exit()
...
description = """Techie-Bomber - Your Friendly Spammer Application

Techie-Bomber can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

Techie-Bomber is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by SpeedX !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start Techie-Bomber with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start Techie-Bomber with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start Techie-Bomber with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update Techie-Bomber")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current Techie-Bomber contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current Techie-Bomber version")
